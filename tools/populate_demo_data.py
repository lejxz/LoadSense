...
CEBU_ROUTES = [
    ...
    {"id": "PH-MyBus1", "name": "MyBus SM Seaside - SM City", "type": "BUS", "origin": (10.2811, 123.8811), "dest": (10.3115, 123.9182), "tag": "MYBUS"},
    {"id": "PH-MyBus2", "name": "MyBus SM City - Airport", "type": "BUS", "origin": (10.3115, 123.9182), "dest": (10.3251, 123.9781), "tag": "MYBUS"}
]
